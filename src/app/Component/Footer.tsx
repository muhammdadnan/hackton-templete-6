...
const Footer = () => {
  return (
    <footer className="bg-Button h-auto flex flex-col justify-center items-center w-full px-4  md:px-16 lg:px-24 py-7 md:py-5 lg:pt-15 sm:container  sm:m-auto sm:px-14">
      <div className="w-full h-auto flex flex-col gap-[48px]">
        <div className="w-full h-auto flex flex-col lg:flex-row justify-between gap-8 lg:gap-[48px]">
          ...
          <div className="flex flex-col gap-11 w-full lg:w-[30%] sm:text-center">
            <h2 className="text-xl font-medium text-[#9F9F9F]">Links</h2>
            <ul className="text-xl font-medium gap-6 text-black flex flex-col justify-between h-full">
              <li>Home</li>
              <li>Shop</li>
              <li>About</li>
              <li>Contact</li>
          ...
          <div className="flex flex-col gap-[50px] w-full lg:w-[30%] h-auto sm:text-center">
          ...
          <div className="flex flex-col gap-[50px] w-full lg:w-[30%]">
            <h2 className="text-[16px] font-medium text-[#9F9F9F] text-center">
              Newsletter
            </h2>
        ...
        <div className="pt-[16px] w-full border-t border-[#D9D9D9] text-left sm:text-center">
